...
<div id="scanGroup">
    ...
    2 Cars<input type="radio" name="typeScan" checked="checked" value="1"  />
    
    3 Cars<input type="radio" name="typeScan" value="2" />
    
    <div id="Scan1" class="desc" style="display: none;">
       Full Scan
    </div>
    <div id="Scan2" class="desc" style="display: none;">
        Partial Scan
    </div>
