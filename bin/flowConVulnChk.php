...
function flowControl($typeChkLines)
{
    
    
$flowControl_array=array();


//print_r($flowControl_array);
...
function checkSources($chkLine,$chkLineNo,$typeChkLines,$typeChkLine)
{
    ...
    $listLen=count($possibleWarmhole); 
    ...
    for($i=0;$i<$varLenth;$i++)
    {
        ...
        for($j=0;$j<$listLen;$j++)
        {
            ...
            {
                if(strcmp($chkLine[$i],$possibleWarmhole[$j])==0)
                {
...
{
         array_push($GLOBALS['flowControl_array'],htmlspecialchars($string));
}


//echo "<br>".$flowControl_array[0];
$length=count($flowControl_array);
...
//    
//    
//    echo "<br>".htmlspecialchars($flowControl_array[$i])." ".htmlspecialchars($flowControl_array[++$i]);
//    if($length==$i)
//    {
//        break;
//    }
//   $i=$i++;
//    
//    if(strcmp($flowControl_array[$i],'new')==0)
//    {
//        echo "<br>Line is <br>".htmlspecialchars($flowControl_array[$i]);
//        $i=$i++;
//    
//    }
//}
...
for($i=0;$i<$length;$i++)
{
    if($flowControl_array[$i]=='new')
    {
//        echo "<br>occured";
    }
    else
    {
        echo "<br>".$flowControl_array[$i];
    }
}
