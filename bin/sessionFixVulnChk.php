...
//    
//    
//    echo "<br>".htmlspecialchars($session_array[$i])." ".htmlspecialchars($session_array[++$i]);
//    if($length==$i)
//    {
//        break;
//    }
//   $i=$i++;
//    
//    if(strcmp($session_array[$i],'new')==0)
//    {
//        echo "<br>Line is <br>".htmlspecialchars($session_array[$i]);
//        $i=$i++;
//    
//    }
//}
