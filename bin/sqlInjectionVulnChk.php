...
global $tempVarVulnCkh; //To check if Var line is vulnerable to sql injetcion 
...
//             echo "This Line May be Vulnerable to Sql Injection<br>";
           ...
           checkforSinks($sendLine,$typeChkLines,$lineno);
...
//        echo "<br>Input Values not found This may be Secure Search Vars  ";
       ...
       $string="<br>Input Values not found Searching variables If no vars found it is Secure ";
...
//                 echo "<br>This Line is Secure with  ".$vulnChkLine[$i];
                ...
                $string=" This Line is Secure with Input Values ".$vulnChkLine[$i];
...
//                 echo "<br>This Line is Secure with  ".$vulnChkLine[$i];
                ...
                $string=" This Line is Secure with Sql Secure values  ".$vulnChkLine[$i];
...
//                 echo $chkprtDecLine;
                 ...
                 push($chkprtDecLine);
                 array_push($sqlrepeat,$chkprtDecLine);
