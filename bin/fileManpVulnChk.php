...
function fileManipulation($typeChkLines)
    
{
    

$fileManip_array=array();
...
{
         array_push($GLOBALS['fileManip_array'],htmlspecialchars($string));
}
...
for($i=0;$i<$length;$i++)
{
    if($fileManip_array[$i]=='new')
    {
//        echo "<br>occured";
    }
    else
    {
        echo "<br>".$fileManip_array[$i];
    }
}
